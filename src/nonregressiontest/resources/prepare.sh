...
(cd $BASEFOLDER && ./deploy.sh $M2_HOME dbmdl-framework com.agifac.lib $VERSION $env $repo)

# echo "Then, run the smoke test"
# (cd $BASEFOLDER && ./smoke.sh $M2_HOME dbmdl-framework com.agifac.lib $VERSION $env $repo)
